...
DATA_DIRECTORY=/users/mcopik/projects/2023/dace_gpu/new_transformation/artifact/data/microbenchmarks/pi/dace_gpu
mkdir -p ${DATA_DIRECTORY}

DIRECTORY=/users/mcopik/projects/2023/dace_gpu/new_transformation/artifact/microbenchmarks/pi/dace/gpu
cd $DIRECTORY
