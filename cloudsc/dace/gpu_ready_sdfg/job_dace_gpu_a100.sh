...
DATA_DIRECTORY=/users/mcopik/projects/2023/dace_gpu/new_transformation/artifact/data/cloudsc/dace/gpu/a100
mkdir -p ${DATA_DIRECTORY}

DIRECTORY=/users/mcopik/projects/2023/dace_gpu/new_transformation/artifact/cloudsc/dace/gpu_ready_sdfg
cd $DIRECTORY
...
for size in 4096 8192 16384 32768 65536 131072 262144; do
  ...
  for nproma in 1; do
    ...
    for rep in {0..19}; do
      ...
      srun --accel-bind=v --cpu-bind=cores,verbose -n ${SLURM_NTASKS} bin/dwarf-cloudsc-fortran  ${SLURM_CPUS_PER_TASK} ${size} ${nproma} > ${DATA_DIRECTORY}/dace_cpu.${SLURM_CPUS_PER_TASK}.${size}.${nproma}.${rep}.txt 2>&1
    done
