...
DATA_DIRECTORY=/users/mcopik/projects/2023/dace_gpu/new_transformation/artifact/data/cloudsc/original/c_cpu
...
for size in 4096 8192 16384 32768 65536 131072 262144; do
  ...
  for nproma in 16 64 128; do
    ...
    for rep in {0..19}; do
      ...
      srun --accel-bind=v --cpu-bind=cores,verbose -n ${SLURM_NTASKS} bin/dwarf-cloudsc-c ${SLURM_CPUS_PER_TASK} ${size} ${nproma} > ${DATA_DIRECTORY}/c.${SLURM_CPUS_PER_TASK}.${size}.${nproma}.${rep}.txt 2>&1
